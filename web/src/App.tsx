...
interface Org { id: string; name: string; role: 'owner' | 'member' | 'read'; personal?: boolean }
...
const MOCK_ORG_DATA: Record<string, OrgData> = {
  'acme-org':       { plan:'Pro',        planPrice:'$29',    storageUsedGB:255,  storageLimitGB:400,  renewsOn:'May 11, 2026'  },
  'gabe-labs':      { plan:'Starter',    planPrice:'$5',     storageUsedGB:12,   storageLimitGB:20,   renewsOn:'Jun 3, 2026'   },
  'oss-collective': { plan:'Team',       planPrice:'$79',    storageUsedGB:1100, storageLimitGB:2048, renewsOn:'Apr 30, 2026'  },
  'personal':       { plan:'Pro',        planPrice:'$29',    storageUsedGB:78,   storageLimitGB:400,  renewsOn:'May 11, 2026'  },
}

const MOCK_ORG_AUDIT: Record<string, AuditEntry[]> = {
  'personal': [
    { id:'p1', timestamp:'2026-04-11 10:00', action:'VM created',           resource:'my-dev-box',     actor:'you' },
    { id:'p2', timestamp:'2026-04-10 14:20', action:'Visibility → private', resource:'my-rust-sandbox',actor:'you' },
  ],
  'acme-org': [
  ...
  'gabe-labs': [
    { id:'b1', timestamp:'2026-04-10 09:20', action:'VM created',           resource:'rust-toolchain',  actor:'gabe'   },
    { id:'b2', timestamp:'2026-04-08 16:44', action:'Downloaded image',     resource:'rust-toolchain',  actor:'you'    },
  ],
  'oss-collective': [
    { id:'c1', timestamp:'2026-04-11 10:05', action:'Image accessed',       resource:'k8s-playground',  actor:'dana'   },
    { id:'c2', timestamp:'2026-04-10 14:30', action:'Downloaded image',     resource:'k8s-playground',  actor:'you'    },
    { id:'c3', timestamp:'2026-04-07 08:12', action:'VM made public',       resource:'k8s-playground',  actor:'dana'   },
  ],
}

const MOCK_PERSONAL_VMS: VM[] = [
  { id:'p1', name:'my-dev-box',      description:'Personal ARM dev environment with Neovim, tmux, and dotfiles.',         arch:'arm64',   os:'Ubuntu 24.04', tags:['personal'],             visibility:'private', namespace:'personal',       disk:'40 GB',   minSpec:{ cpu:'2 vCPU', ram:'4 GB',   disk:'20 GB' } },
  { id:'p2', name:'my-rust-sandbox', description:'Rust nightly sandbox for personal experimentation.',                   arch:'x86_64',  os:'Debian 12',    tags:['rust'],                 visibility:'private', namespace:'personal',       disk:'20 GB',   minSpec:{ cpu:'1 vCPU', ram:'2 GB',   disk:'10 GB' } },
  { id:'p3', name:'my-public-demo',  description:'Public demo environment shared for open-source contributions.',        arch:'x86_64',  os:'Ubuntu 22.04', tags:['demo'],                 visibility:'public',  namespace:'personal',       disk:'15 GB',   minSpec:{ cpu:'1 vCPU', ram:'1 GB',   disk:'8 GB'  } },
]

const MOCK_VMS: VM[] = [
  { id:'1',  name:'ubuntu-dev-node', description:'Node.js 20 dev environment with pnpm and git pre-configured.',         arch:'x86_64',  os:'Ubuntu 24.04', tags:['nodejs','javascript'],  visibility:'public',  namespace:'acme-org',       disk:'40 GB',   minSpec:{ cpu:'2 vCPU', ram:'4 GB',   disk:'20 GB' } },
  { id:'2',  name:'arm-python-ml',   description:'Python 3.12 with PyTorch and CUDA bindings for ARM.',                   arch:'arm64',   os:'Debian 12',    tags:['python','ml'],          visibility:'private', namespace:'acme-org',       disk:'80 GB',   minSpec:{ cpu:'4 vCPU', ram:'16 GB',  disk:'40 GB' } },
  { id:'3',  name:'go-backend',      description:'Minimal Alpine image with Go 1.23 toolchain.',                          arch:'x86_64',  os:'Alpine 3.19',  tags:['golang','backend'],     visibility:'public',  namespace:'acme-org',       disk:'20 GB',   minSpec:{ cpu:'1 vCPU', ram:'512 MB', disk:'10 GB' } },
  { id:'4',  name:'riscv-embedded',  description:'Experimental RISC-V 64 image for embedded targets.',                    arch:'riscv64', os:'Fedora 39',    tags:['embedded'],             visibility:'private', namespace:'acme-org',       disk:'10 GB',   minSpec:{ cpu:'1 vCPU', ram:'1 GB',   disk:'8 GB'  } },
  { id:'5',  name:'rust-toolchain',  description:'Rust stable + nightly with cross-compilation support.',                 arch:'x86_64',  os:'Ubuntu 22.04', tags:['rust','systems'],       visibility:'public',  namespace:'gabe-labs',      disk:'30 GB',   minSpec:{ cpu:'2 vCPU', ram:'4 GB',   disk:'15 GB' } },
  { id:'6',  name:'k8s-playground',  description:'Single-node k3s cluster with Helm and kubectl.',                        arch:'arm64',   os:'Ubuntu 24.04', tags:['kubernetes','docker'],  visibility:'public',  namespace:'oss-collective', disk:'100 GB',  minSpec:{ cpu:'4 vCPU', ram:'8 GB',   disk:'50 GB' } },
  { id:'7',  name:'win11-dev',       description:'Windows 11 Pro with VS Code, Git, WSL2, and .NET 8 SDK pre-installed.', arch:'x86_64',  os:'Windows 11',   tags:['windows','dotnet'],     visibility:'public',  namespace:'acme-org',       disk:'80 GB',   minSpec:{ cpu:'4 vCPU', ram:'8 GB',   disk:'40 GB' } },
  { id:'8',  name:'win10-ltsc',      description:'Windows 10 LTSC for legacy enterprise and compatibility testing.',       arch:'x86_64',  os:'Windows 10',   tags:['windows','legacy'],     visibility:'public',  namespace:'gabe-labs',      disk:'60 GB',   minSpec:{ cpu:'2 vCPU', ram:'4 GB',   disk:'30 GB' } },
  { id:'9',  name:'macos-sequoia',   description:'macOS 15 Sequoia for iOS and macOS development with Xcode 16.',         arch:'arm64',   os:'macOS 15',     tags:['macos','xcode'],        visibility:'public',  namespace:'acme-org',       disk:'120 GB',  minSpec:{ cpu:'4 vCPU', ram:'8 GB',   disk:'60 GB' } },
  { id:'10', name:'macos-tahoe',     description:'macOS 26 Tahoe early-access image for Swift and CI pipelines.',         arch:'arm64',   os:'macOS 26',     tags:['macos','swift','ci'],   visibility:'public',  namespace:'oss-collective', disk:'130 GB',  minSpec:{ cpu:'4 vCPU', ram:'8 GB',   disk:'65 GB' } },
  { id:'11', name:'freebsd-base',    description:'FreeBSD 14.1 minimal base system for networking and BSD workloads.',    arch:'x86_64',  os:'FreeBSD 14',   tags:['bsd','networking'],     visibility:'public',  namespace:'oss-collective', disk:'20 GB',   minSpec:{ cpu:'1 vCPU', ram:'1 GB',   disk:'10 GB' } },
]
...
const MOCK_COMMENTS: Comment[] = [
  { id:'c1', author:'gabe', time:'2h ago', text:'Works great on M2 Mac. Had to adjust the network MTU but otherwise smooth.' },
  { id:'c2', author:'alex', time:'1d ago', text:'Does this support cloud-init? Trying to pass user-data on first boot.'       },
  { id:'c3', author:'you',  time:'1d ago', text:'Yes — cloud-init is included. Pass --user-data when pulling the image.'      },
]
...
function getOsFamily(os: string): OsFamily {
  ...
  if (l.includes('ubuntu') || l.includes('debian') || l.includes('alpine') ||
      l.includes('fedora') || l.includes('centos') || l.includes('arch') ||
      l.includes('linux'))                                        return 'linux'
  return 'other'   // FreeBSD, OpenBSD, Haiku, etc.
}

// ── Shared ─────────────────────────────────────────────────────

function Badge({ children, variant }: { children: React.ReactNode; variant: 'arch'|'public'|'private'|'tag' }) {
  ...
  return (
    <div className={`vm-card vm-arch-${vm.arch}`} onClick={onClick}>
      ...
      <div className="vm-badges">
        ...
        {vm.tags.map(t => <Badge key={t} variant="tag">{t}</Badge>)}
      </div>
  ...
  return (
    <div className="overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-sub">{vm.namespace}/{vm.name}</div>
        ...
        <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.55, marginBottom: 16 }}>
          {vm.description}
        </p>

        <div className="inset mb-10">
          <div className="section-label" style={{ marginBottom: 14 }}>Specs &amp; Size</div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14 }}>
            <div className="spec-block">
              <div className="spec-key">OS</div>
              <div className="spec-value" style={{ fontSize: 'var(--fs-ui)' }}>{vm.os}</div>
            </div>
            <div className="spec-block">
        ...
        <div className="mt-16">
          <div className="section-label" style={{ marginBottom: 8 }}>Discussion</div>
          {MOCK_COMMENTS.map(c => (
          ...
          <div className="comment-input-row">
            ...
            />
            <button className="btn btn-primary btn-sm" style={{ alignSelf: 'flex-end' }}>Post</button>
          </div>
        </div>
  ...
  return (
    <>
      {vms.length === 0
        ...
        : <div className="vm-grid">{vms.map(vm => <VMCard key={vm.id} vm={vm} onClick={() => setSelected(vm)} />)}</div>
      }
    ...
    <>
      ...
      <div className="stat-grid">
        <div className="stat-card">
          ...
          <div className="stat-value">{data.planPrice}<span>/mo</span></div>
          <div className="stat-sub">{data.plan} · renews {data.renewsOn}</div>
        </div>
        <div className="stat-card">
          <div className="stat-card-label">Storage used</div>
          <div className="stat-value">{data.storageUsedGB} <span>GB</span></div>
          <div className="progress">
            <div className={`progress-fill ${barCls}`} style={{ width: `${pct}%` }} />
          </div>
          <div className="stat-sub">{pct}% of {data.storageLimitGB} GB tier limit</div>
        </div>
      </div>
      ...
      <div className="plan-grid">
        {[
          { name:'Free',       price:'$0',     sub: null,                          features:['Unlimited public VM pulls','Join organizations','Community support'],                                            current:false },
          { name:'Pro',        price:'$5',     sub: '+ $0.75 / 10 GB added',       features:['50 GB VM storage included','Private VMs','Audit log','Email support','Priority support'],                       current:true  },
          { name:'Enterprise', price:'Custom', sub: 'per month',                   features:['Custom deletion retention','VM history + revert','VM versioning','Priority support','Custom contracts'],         current:false },
        ].map(p => (
          <div key={p.name} className={`plan-card ${p.current ? 'current' : ''}`}>
            ...
            {p.sub && <div style={{ fontSize: 'var(--fs-label)', color: 'var(--text-muted)', marginBottom: 14, marginTop: -10 }}>{p.sub}</div>}
  ...
  return (
    <div className="stat-grid">
      <div className="stat-card">
        ...
        <div className="stat-value">288 <span>GB used</span></div>
        <div className="stat-sub">of 1.2 TB allocated</div>
      </div>
      <div className="stat-card">
        <div className="stat-card-label">Available</div>
        <div className="stat-value">912 <span>GB free</span></div>
        <div className="progress">
...
function Navbar({ setPage, loggedIn, setLoggedIn, search, setSearch }: {
  setPage: (p: Page) => void
  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-search">
        <span className="search-icon"><i className="fi fi-rr-search" /></span>
        <input
          type="text"
      ...
      <div className="navbar-right">
        ...
        {loggedIn ? (
          <>
            ...
            <div className="avatar" title="Log out" onClick={() => setLoggedIn(false)}>JD</div>
          </>
        ) : (
          <>
            <button className="btn btn-ghost btn-sm" onClick={() => setLoggedIn(true)}>Log in</button>
            <button className="btn btn-primary btn-sm" onClick={() => { setLoggedIn(true); setPage('dashboard') }}>Sign up</button>
          </>
        )}
      </div>
    </nav>
...
function Sidebar({ page, setPage, activeCategory, setActiveCategory, loggedIn, dashTab, setDashTab, org, setOrg, mode }: {
  page: Page; setPage: (p: Page) => void
  activeCategory: string; setActiveCategory: (v: string) => void
  loggedIn: boolean; dashTab: DashTab; setDashTab: (t: DashTab) => void
  org: Org; setOrg: (o: Org) => void
  mode: Mode
}) {
    ...
    <aside className="sidebar">
      {loggedIn && (
        <>
          ...
          <div className="org-switcher" onClick={() => setOrgOpen(o => !o)}>
            {org.personal
              ? <div className="personal-avatar"><i className="fi fi-sr-user" style={{ fontSize: 12 }} /></div>
          ...
          {orgOpen && (
            <div className="org-dropdown">
              ...
              <div
                ...
                onClick={() => { setOrg(PERSONAL_ORG); setOrgOpen(false); }}
              >
              ...
              {MOCK_ORGS.map(o => (
                ...
                >
                  ...
                  <span style={{ fontSize: 'var(--fs-label)', color: 'var(--text-muted)' }}>{o.role}</span>
          ...
          <div className="sb-section">
            ...
            ] as [DashTab, string, string][]).map(([id, icon, label]) => (
              <div
                key={id}
                className={`sb-item ${page === 'dashboard' && dashTab === id ? 'active' : ''}`}
                data-tab={id}
                onClick={() => { setPage('dashboard'); setDashTab(id) }}
              >
                <span className="sb-icon"><i className={icon} /></span>
                {label}
              </div>
            ))}
          </div>
      ...
      <div className="sb-section">
        ...
        <div
          ...
          onClick={() => { setPage('home'); setActiveCategory('') }}
        >
          <span className="sb-icon"><i className="fi fi-rr-apps" /></span>
          All VMs
        </div>
      </div>
        ...
        <div key={cat.label} className="sb-section">
          ...
          {cat.items.map(item => (
            <div
              ...
              onClick={() => { setPage('home'); setActiveCategory(item.label) }}
            >
...
function HomePage({ search, activeCategory }: { search: string; activeCategory: string }) {
  ...
  const visible = MOCK_VMS.filter(vm => {
    ...
    if (search) {
      ...
      if (!vm.name.includes(q) && !vm.os.toLowerCase().includes(q) &&
          !vm.arch.includes(q) && !vm.tags.some(t => t.includes(q))) return false
    }
    if (activeCategory) {
    ...
    <div className="main">
      <div className="hero">
        <div className="hero-filters">
          {['All', 'x86_64', 'arm64', 'riscv64'].map(f => (
            <button key={f} className={`chip ${arch === f ? 'active' : ''}`} onClick={() => setArch(f)}>
              {f}
            </button>
          ))}
        </div>
      ...
      <div className="page" style={{ paddingTop: 0 }}>
        ...
        {visible.length === 0
          ...
          : <div className="vm-grid mt-10">{visible.map(vm => <VMCard key={vm.id} vm={vm} onClick={() => setSelected(vm)} />)}</div>
        }
      </div>
...
function DashboardPage({ tab, setTab, org, mode }: {
  tab: DashTab; setTab: (t: DashTab) => void; org: Org; mode: Mode
}) {
  ...
  return (
    <div className="main">
      ...
      <div className="page">
        ...
        {tab === 'billing' && (mode === 'self_hosted' ? <StorageTab /> : <BillingTab data={orgData} />)}
    ...
    <div className="main">
      ...
      <div className="page" style={{ paddingTop: 0 }}>
        <div className="plan-grid" style={{ maxWidth: 760, margin: '0 auto' }}>
          {[
            { name:'Free',       price:'$0',     sub: null,                    features:['Unlimited public VM pulls','Join organizations','Community support']                                            },
            { name:'Pro',        price:'$5',     sub: '+ $0.75 / 10 GB added', features:['50 GB VM storage included','Private VMs','Audit log','Email support','Priority support']                       },
            { name:'Enterprise', price:'Custom', sub: 'per month',             features:['Custom deletion retention','VM history + revert','VM versioning','Priority support','Custom contracts']         },
          ].map(p => (
...
export default function App() {
  ...
  return (
    <div className="layout">
      ...
      {page === 'dashboard' && loggedIn && <DashboardPage tab={dashTab} setTab={setDashTab} org={org} mode={mode} />}
      {page === 'dashboard' && !loggedIn && (
        <div className="main">
          <div className="empty" style={{ paddingTop: 120 }}>
            <div style={{ marginBottom: 16 }}>Sign in to view your dashboard</div>
            <button className="btn btn-primary" onClick={() => setLoggedIn(true)}>Log in</button>
          </div>
        </div>
      )}
